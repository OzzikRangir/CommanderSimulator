...
public class KinectManager : MonoBehaviour
{
	...
	public Smoothing velocitySmoothing = Smoothing.Default;
	...
	protected DepthSensorInterface sensorInterface = null;
...
//		}
	...
	void Awake ()
	{
		...
		try {
			...
			sensorInterface = KinectInterop.InitSensorInterface (bOnceRestarted, ref bNeedRestart);
...
//				dwFlags |= KinectInterop.FrameSource.TypeAudio;
			...
			sensorData = KinectInterop.OpenDefaultSensor (sensorInterface, dwFlags, sensorAngle, useMultiSourceReader);
